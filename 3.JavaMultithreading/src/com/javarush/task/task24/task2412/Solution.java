...
public class Solution {
    ...
    public static void printStocks(List<Stock> stocks, Date actualDate) throws IllegalArgumentException {
    ...
    public static Date getRandomDate(int startYear) throws IllegalArgumentException  {
